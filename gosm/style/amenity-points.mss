@marina-text: @water-text-soft; // also swimming_pool
@wetland-text: @water-text-soft; /* Also for mud */
@shop-icon: @base-56;
@shop-text: @label-light;
@transportation-icon: @base-60;
@transportation-text: @label;
@accommodation-icon: @transportation-icon;
@accommodation-text: @transportation-text;
@airtransport: @base-56; //also ferry_terminal
@health-color: @base-52;
@amenity-brown: @base-52;
@gastronomy-icon: @base-56;
@gastronomy-text: darken(@gastronomy-icon, 5%);
@memorials: @amenity-brown;
@culture: @amenity-brown;
@public-service: @amenity-brown;
@office: @base-60;
@man-made-icon: @base-56;
@advertising-grey: @man-made-icon;
@barrier-icon: @label-strong;
@landform-color: @base-64;
@leisure-green: @label-light;
@protected-area: @base-60;
@aboriginal: @base-60;
@religious-icon: @label-strong;
...
#text-point[zoom >= 10] {
  ...
  [feature = 'tourism_viewpoint'][zoom >= 16] {
    ...
    [feature = 'natural_volcano'] { text-fill: @base-52; }
...
#waterslide {
  [zoom >= 17] {
	bridgecasing/line-color: @road_casing_dark;
	bridgecasing/line-join: round;
	bridgecasing/line-width: 1.25;
	[zoom >= 18] { bridgecasing/line-width: 2.5; }
	[zoom >= 19] { bridgecasing/line-width: 5; }
...
#trees [zoom >= 16] {
  ...
  [natural = 'tree']::trunk {
    [zoom >= 18] {
      trunk/opacity: 0.4;
      trunk/marker-fill: @base-64; // Same opacity and color as forest svg patterns
