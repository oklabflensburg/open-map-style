#aerialways {
  ...
  [aerialway = 'mixed_lift'] {
    [zoom >= 12] {
      ...
      line/line-cap: round;
      line/line-color: @base-64;

      dash/line-width: 3;
      dash/line-join: round;
      dash/line-cap: round;
      dash/line-color: @road_casing_dark;
  ...
  [man_made = 'pipeline'] {
    [zoom >= 14] {
      line/line-width: .7;
      line/line-join: round;
      line/line-color: @base-68;
      line/line-dasharray: 0,.7,14,.7;
      dash/line-width: 2;
      dash/line-join: round;
      dash/line-color: @base-68;
      ...
      [zoom >= 17] {
        ...
        [substance = 'gas'] { center/line-color: @base-80; }
        [substance = 'oil'] { center/line-color: @base-76; }
      }
      [zoom >= 18] {
        line/line-width: 3;
