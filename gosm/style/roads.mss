...
@tertiary-fill: @road_major;
@residential-fill: @road_minor;
@service-fill: @residential-fill;
@living-street-fill: @base-95;
@pedestrian-fill: @base-92;
@raceway-fill: @base-90;
@road-fill: @base-90;
@footway-fill: @road_path;
@footway-fill-noaccess: @base-80;
@steps-fill: @footway-fill;
@steps-fill-noaccess: @base-80;
@cycleway-fill: @base-72;
@cycleway-fill-noaccess: @base-80;
@bridleway-fill: @base-68;
@bridleway-fill-noaccess: @base-80;
@track-fill: @road_track;
@track-fill-noaccess: @base-84;
@platform-fill: @base-80;
@aeroway-fill: @base-84;
@runway-fill: @aeroway-fill;
@taxiway-fill: @aeroway-fill;
@helipad-fill: @aeroway-fill;
@access-marking: @road_marking;
/* access-marking-light is used on some darker highways for better contrast */
@access-marking-light: @road_marking_light;
@access-marking-secondary: @base-92;
@access-marking-white-unpaved: @base-90;
@access-marking-living-street: @base-88;

@default-casing: @base-100;
@tertiary-casing: @road_casing;
@residential-casing: @base-80;
@road-casing: @residential-casing;
@service-casing: @residential-casing;
@living-street-casing: @residential-casing;
@pedestrian-casing: @base-72;
...
@tertiary-shield: @label-strong;

@unimportant-road: @residential-casing;

@minor-construction: @base-76;
@service-construction: @base-76;

@destination-marking: @base-88;
@private-marking: @base-84;
@private-marking-for-red: @base-56;

@tunnel-casing: @base-68;
@bridge-casing: @road_casing_dark;
...
@junction-text-color:             @label-light;
@halo-color-for-minor-road:       @halo;
@lowzoom-halo-color:              @halo;
...
#tunnels[zoom >= 10] {
  ...
  ::fill {
    ...
    [feature = 'railway_INT-spur-siding-yard'][zoom >= 13] {
      ...
      [zoom >= 12] {
        #roads-fill, #bridges {
          ...
          light/line-color: @halo;
          light/line-join: round;
          [feature = 'railway_rail'] {
            dark/line-color: @base-56;
            dark/line-width: 2;
    ...
    [feature = 'railway_narrow_gauge'] {
      ...
      [zoom >= 12] {
        line-color: @base-84;
        [zoom >= 10] { line-color: @base-76; }
        [zoom >= 13] { line-color: @base-52; }
        line-width: 1;
        [zoom >= 13] { line-width: 2; }
        [preserved = 'yes'][zoom >= 13] {
          #roads-fill, #bridges {
            dark/line-width: 3;
            dark/line-color: @base-72;
            light/line-width: 1;
            light/line-color: @halo;
            light/line-dasharray: 0,1,8,1;
            light/line-join: round;
    ...
    [feature = 'railway_miniature'] {
      [zoom >= 15] {
        line/line-width: 1.2;
        line/line-color: @base-72;
        dashes/line-width: 3;
        dashes/line-color: @base-72;
        dashes/line-dasharray: 1,10;

        [preserved = 'yes'] {
          line/line-width: 3;
          line/line-color: @base-80;
          dashes/line-width: 1;
          dashes/line-color: @halo;
    ...
    [feature = 'railway_monorail'] {
      [zoom >= 14] {
        ...
        background/line-color: @halo;
        background/line-opacity: 0.4;
        background/line-cap: round;
        background/line-join: round;
        line/line-width: 3;
        line/line-color: @base-56;
