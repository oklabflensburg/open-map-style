...
@grass: #f3f4f5; // also grassland, meadow, village_green, garden, allotments
@scrub: #f3f4f5;
@forest: #f3f4f5;
@forest-text: #3d434a;
@park: #f3f4f5;
@allotments: #f3f4f5;
@orchard: #f3f4f5; // also vineyard, plant_nursery
@hedge: #f3f4f5;


// --- "Base" landuses ---

@built-up-lowzoom: lighten(#f6f6f6, 15%);
@built-up-z12: #f6f6f6;
@residential: #f6f6f6;
@residential-line: darken(#f6f6f6, 15%);
@retail: #f6f6f6;
@retail-line: darken(#f6f6f6, 15%);
@commercial: #f6f6f6;
@commercial-line: darken(#f6f6f6, 15%);
@industrial: #f6f6f6; // (Also used for railway, wastewater_plant)
@industrial-line: darken(#f6f6f6, 15%); // (Also used for railway-line, wastewater_plant-line)
@farmland: #f3f4f5;
@farmland-line: darken(#f3f4f5, 15%);
@farmyard: #f3f4f5;
@farmyard-line: darken(#f3f4f5, 15%);


// --- Transport ----

@transportation-area: #f3f4f5;
@apron: #f3f4f5;
@garages: #f3f4f5;
@parking: #f3f4f5;
...
@rest_area: #f3f4f5; // also services


// --- Other ----

@bare_ground: #eee5dc;
@campsite: #ececec; // also caravan_site, picnic_site
@cemetery: #f3f4f5; // also grave_yard
@construction: #f3f4f5; // also brownfield
@heath: #f3f4f5;
@mud: lighten(@water-color, 5%);
